...
?>     
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <span class="brand-text font-weight-light">Ventas "El Dorado"</span>
    <div class="text-center mb-4">
                            <img src="../log/log.jpg" class="img-fluid rounded-circle" alt="Login Image" width="130px">
                        </div>
      </a>
      <div class="sidebar">
        <div class="">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="venta_mesa.php" class="nav-link">
                <i class="nav-icon fas fa-box"></i>
                <p>
                  Comer en Mesa
                </p>
